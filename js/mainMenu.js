...
/** jMenu Plugin **/
(function($) {
	var ULWidth,isMobile=!!window.navigator.platform.match(/ios|iphone|ipad|ipod|android/i);
	$.jMenu={
		/**************/
		/** OPTIONS **/
		/**************/
...
//			if(!opts.openClick){
				...
				$('.jMenu li a.fNiv + ul>li a:not(.fNiv)').bind({click:timeout});
//			}else{
				$('.jMenu li a.fNiv.mc').bind({
					click:function(e){
						e.preventDefault();
						var $this=$(this);
						var $child=$this.next();
...
//					ULWidth=parseInt(el.outerWidth(true));
	...
	jQuery.fn.jMenu=function(options){
		$(this).addClass('jMenu');
//		if(isMobile){
//			var $sm=$(this).children('li').children('ul').parent(),//sub menu
//				$ul=$(this).children('ul');
//			$sm.children('a').first().before('<a></a>').each(function(){
//				$(this).prev().html($(this).html());
//				$(this).next('ul').children().first().after('<li></li>').next().after(this);
////				$('ul>li:first',this).after('<li></li>').next().after(this);
//			});
//		}
		//$(this).children('li').children('ul').parent().children('a').first().addClass('fNiv');
