...
/**
 * Mobile Detect
 * $Id: Mobile_Detect.php 41 2012-04-24 19:10:16Z serbanghita@gmail.com $
 * 
...
class Mobile_Detect {
	...
	{
		if($name=='is') return $this->_detect($arguments[0]);
		$key = substr($name, 2);
	 ...
	 * Returns true if any type of phone device detected, including some special devices that works like a phone
	 * @return bool
	 */
	...
	public function isMobile()
	{
		...
		return $this->isMobile&&!$_SESSION['ws-tags']['ws-user']['fullversion'];
	}
}
