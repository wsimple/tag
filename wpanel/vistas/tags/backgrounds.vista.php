<?php 
     if ($_REQUEST['action']=="insert"){
	     ...
	     //echo $_REQUEST[path].$_REQUEST[photo];
    ...
    <tr>
        ...
        <fieldset>
       	<legend>List Backgrounds</legend>
                ...
                <td style="border-bottom:1px solid #FBCBA4; text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/Abstract/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4; text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/Fashion/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4; text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/Music/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4; text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/Politics/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4; text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/tvAndMovies/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4; text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/Sports/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4;text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4;text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/holiday/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                <tr style="background-color:#FDE2CC; color:#000000; font-weight:bold">
                <td style="border-bottom:1px solid #FBCBA4; border-right:1px solid #FBCBA4" width="72">Type</td>
                ...
                <td style="border-bottom:1px solid #FBCBA4;text-align:center"><img src="../img/delete.png" width="14" height="14" border="0" style="cursor:pointer" onClick="confirma('Delete Picture', 'Sure to delete this photo', '?action=delete&url=<?=$_REQUEST[url]?>&path=../img/templates/defaults/thanksgiven/&photo=<?=$pic?>');" /></td>
                </tr>
                <?php }} ?>
                </table>
        </fieldset>
