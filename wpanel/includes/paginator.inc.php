 ...
 */
 ...
 $_pagi_navegacion = "<ul id='pagination'><li>".implode($_pagi_separador, $_pagi_navegacion_temporal)."</li></ul>";
 ...
 */
 ...
 $_pagi_info = "<ul id='pagination'><li class='active'>Showing $_pagi_desde - $_pagi_hasta of $_pagi_totalReg</li></ul>";
