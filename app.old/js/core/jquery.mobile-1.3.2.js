	...
	$.widget( "mobile.loader", {
		...
		show: function( theme, msgText, textonly ) {
			...
			if ( $.mobile.loadingMessage !== false || loadSettings.html ) {
				...
				//Para mover el loader temporal(NO IMPLEMENTADO al 100%) 
				var attacher = ($('#loader-wrapper').length>0) ? $('#loader-wrapper'):$.mobile.pageContainer;
				// attach the loader to the DOM
				this.element.appendTo( attacher );
