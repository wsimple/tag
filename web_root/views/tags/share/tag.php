	...
	<table class="ui-smt-single">
		...
		<tr>
			...
			<td style=" padding-right: 21px;">
				<input type="button" class="ui-smt-float-right" id="view_friends" value="<?=BTN_VIEWFRIENDS?>"/>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="3">
				<div style="float:right;width:470px;">
					<iframe src="views/tags/share/facebook.php?tag=<?=$_GET['tag']?>" width="170px" frameborder="0" scrolling="no" height="40px" allowtransparency="true" style="float:left;"></iframe>
					<iframe src="views/tags/share/twitter.php?tag=<?=$_GET['tag']?>" width="170px" frameborder="0" scrolling="no" height="40px" allowtransparency="true" style="float:right;"></iframe>
				</div>
			</td>
		</tr>
