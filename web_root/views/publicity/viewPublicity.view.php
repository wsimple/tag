...
<tr>
  ...
  <img src="<?='.?resizeimg&ancho=160&tipo=3&img='.FILESERVER.getPublicityPicture('img/publicity/'.$dato['picture'],'img/publicity/publicity_nofile.png')?>" style="border:1px solid #CCC"  /></td>
</tr>
<?php } ?>
