...
class valid
{
	...
	{
		if (preg_match("/^((https?:\/\/)?(www\.)?)?([a-z][-a-z0-9]+\.)?([a-z][-a-z0-9]*)(\.[a-zA-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel)(\.[a-z]{2})?(\/.*)?/i", $value))
