...
(function(window){
	...
	if(actual=='es') more['es']={//español
		...
		USER_BTNSEEMORE					:'Ver m&aacute;s',
		USER_PROFILE					:'Perfil',
		...
		yes								:'S&iacute;',
		INFO	:{//información de noticias y notificaciones
			1	:'[_UD_] recibi{&oacute;}{{eron}} una tag privada de [_FRIENDS_]',
			2	:'[_FRIENDS_] le{{s}} gusta [_TAG_]',
			4	:'[_FRIENDS_] coment{&oacute;}{{aron}} [_TAG_]',
			5	:'[_FRIENDS_] [_TE_] agreg{&oacute;}{{aron}} como amigo [_A_]',
			6	:'[_FRIENDS_] [_TE_] agreg{&oacute;}{{aron}} [_A_] a un grupo',
			7	:'[_FRIENDS_] comparti{&oacute;}{{eron}} [_TAG_]',
			8	:'[_FRIENDS_] redistribuy{&oacute;}{{eron}} [_TAG_]',
			9	:'[_FRIENDS_] patrocin{&oacute;}{{eron}} [_TAG_]',
			10	:'[_FRIENDS_] agreg{&oacute;}{{aron}} una Tag de grupo',
			11	:'[_FRIENDS_] [_TE_] sigue{{n}} [_A_]',
			12	:'[_FRIENDS_] quiere{{n}} unirse al grupo [_GROUP_]',
			13	:'[_FRIENDS_] aprob&oacute; tu solicitud para unirte al grupo [_GROUP_]',
			replace	:[//remplazos alternativos.
				[//que remplasar, si eres tu, si es otro usuario
					['[_TAG_]','tu Tag','la Tag de [_USR_]'],
					['[_SIGUE_]','te sigue{{n}}','sigue{{n}} a [_USR_]'],
					['[_UD_]','Ud.','[_USR_]'],
					['[_TE_]','te',''],
					['[_A_]','','a [_USR_]']
				],[//remplasos posteriores (luego de sustituir los amigos)
					['[_AND_]','y'],
					['[_MORE_]','amigos m&aacute;s']
				]
			]
		}
	};//es
	lang={//ingles por defecto
		...
		INFO	:{//información de noticias y notificaciones
			1	:'[_YOU_] receibed a private tag from [_FRIENDS_]',
			2	:'[_FRIENDS_] like [_YOUR_] Tag',
			4	:'[_FRIENDS_] comented [_YOUR_] Tag',
			5	:'[_FRIENDS_] added [_YOU_] as a friend',
			6	:'[_FRIENDS_] added [_YOU_] to a group',
			7	:'[_FRIENDS_] shared [_YOUR_] Tag',
			8	:'[_FRIENDS_] redistributed [_YOUR_] Tag',
			9	:'[_FRIENDS_] patrocinate [_YOUR_] Tag',
			10	:'[_FRIENDS_] added a group Tag',
			11	:'[_FRIENDS_] follow [_YOU_]',
			12	:'[_FRIENDS_] want to join to the group [_GROUP_]',
			13	:'[_FRIENDS_] approved [_YOUR_] request to join to the group [_GROUP_]',
			replace	:[//remplazos alternativos.
				[//[que remplasar, si eres tu, si es otro usuario]
					['[_YOU_]',		'you',	'[_USR_]'		],
					['[_YOUR_]',	'your',	"an [_USR_]'s"	]
				],[//remplasos posteriores (luego de sustituir los amigos)
					['[_AND_]',		'and'],
					['[_MORE_]',	'more friends']
				]
