<?php
session_start();
$__val=$_SESSION['ws-tags']['ws-user']['id']!=''?$_SESSION['ws-tags']['ws-user']['id']:NULL;
$__time=time()+($__val?60*30:-3600);
...
if(isset($_SESSION['ws-tags'])&&strpos($_SERVER['SERVER_NAME'],$__dominio)!==FALSE){
	$__dominio='.'.$__dominio;
	setcookie('__uid__',$__val?md5($__val):NULL,$__time,'/',$__dominio);
}
unset($__dominio,$__val,$__time);
